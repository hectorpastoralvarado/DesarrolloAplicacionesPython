...
public class SeleccionModuloActivity extends AppCompatActivity implements AdapterView.OnItemClickListener, View.OnClickListener {
    ...
    private ImageButton btnStreamin;
    private ImageButton btnTv;

    private ImageButton imvPreferences;
    ...
    private void initComponents(){
        ...
        imvPreferences = (ImageButton)findViewById(R.id.imv_preferences);
        imvPreferences.setOnClickListener(this);
        btnCalificar = (ImageButton)findViewById(R.id.btn_calificar);
        btnCalificar.setOnClickListener(this);
        btnAyuda = (ImageButton)findViewById(R.id.btn_help);
        btnAyuda.setOnClickListener(this);
        btnStreamin = (ImageButton)findViewById(R.id.btn_streamin);
        btnStreamin.setOnClickListener(this);
        btnTv = (ImageButton)findViewById(R.id.btn_tv);
        btnTv.setOnClickListener(this);

        preferences = PreferenceManager.getDefaultSharedPreferences(this);
        btnPerfil.setText(preferences.getString("nombre_user", "Perfil"));
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {//falta colocar en caso de que de clic en examen final
        ...
        if (valoresRecibidosLogin.getBoolean("logeo")){
            ...
            switch (position){
                ...
                case 4:///--------------------------------------------------------------------------Examen Fianl 1
                    ...
                    if (activo) {
                        ...
                        MensajeError("Para poder accesar a este examen necesita concluir con exito todos los modulos", "Examen Bloqueado");
                    }
                    break;
            }
            if (pasarSiguiente!=0){
            ...
            if (pasarErro!=0){
                MensajeError("Para poder accesar a este modulo necesita concluir con exito el anterios", "Modulo Bloqueado");
                pasarErro=0;
            }
            ...
            if (position==0){
                ...
                MensajeError("Para poder accesar a este examen necesita registrarse en la aplicación", "Examen Bloqueado");
            }else {
                MensajeError("Para poder accesar a este modulo necesita registrarse en la aplicación", "Modulo Bloqueado");
            }
        }
    }
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.btn_about:
                startActivity(new Intent(SeleccionModuloActivity.this, AboutActivity.class));
                break;
            case R.id.imv_preferences:
                startActivity(new Intent(SeleccionModuloActivity.this, SeleccionPreferenciasActivity.class));
                break;
            case R.id.btn_help:
            ...
            case R.id.btn_streamin:
                startActivity(new Intent(SeleccionModuloActivity.this,RadioActivity.class));
                break;

            case R.id.btn_tv:
                startActivity(new Intent(SeleccionModuloActivity.this,TvActivity.class));
                break;

            default:
                Toast.makeText(getApplicationContext(), "Opcion Invalida", Toast.LENGTH_SHORT).show();
                break;
        }
