...
public class SeleccionTemaActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        if (valoresRecibidos.getBoolean("logeo")) {
                    ...
                    switch (position){
                        ...
                        case 7://-------------------------------------------------------------------Exam
                            ...
                            if (activo) {
                                ...
                                MensajeError("Para poder accesar a este examen necesita concluir con exito los temas anteriores", "Examen Bloqueado");
                            }
                            break;
                        default:
                            break;
            ...
            if (pasarErr!=0){
                MensajeError("Para poder accesar a este tema necesita concluir con exito el anterios", "Tema Bloqueado");
                pasarErr=0;
            }
        }else {
            if (position==0){
                ...
                MensajeError("Para poder accesar a este modulo necesita registrarse en la aplicación", "Tema Bloqueado");
            }
        }
