...
import utng.edu.mx.proyectofinal.FormLoginActivity;
import utng.edu.mx.proyectofinal.dao.DBHelper;
import utng.edu.mx.proyectofinal.model.Modulo;
import utng.edu.mx.proyectofinal.model.Tema;
...
public class DBAdapter {
    ...
    public void addModulos(int idUsuario){
        ...
        modulo=new Modulo("Modulo 1",idUsuario,true,8);
        ...
        this.addModulo(modulo);
        modulo=new Modulo("Examen Final",idUsuario,true,8);
        this.addModulo(modulo);
    ...
    private void addTemas(int posicionMod,int idModulo){
        ...
        switch (posicionMod){
            case 1:
                ...
                addTema(tema);
                tema=new Tema("Modulo1_Tema2",idModulo,true);//Medio ambiente de configuracion
                addTema(tema);
            ...
            case 4:
                ...
                addTema(tema);
                tema=new Tema("Modulo4_Examen",idModulo,true);
                addTema(tema);
                break;
        }
    }
